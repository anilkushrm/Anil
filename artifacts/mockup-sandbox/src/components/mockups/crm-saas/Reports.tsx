...
export function Reports() {
  ...
  return <div className="flex min-h-[100dvh] bg-[#f5f8fb] text-[#18241f]"><Sidebar active="Reports" /><main className="min-w-0 flex-1 overflow-y-auto"><Topbar title="Reports & Analytics" subtitle="Understand the conversations that move your business forward." /><div className="space-y-5 px-5 py-6 md:px-7">
