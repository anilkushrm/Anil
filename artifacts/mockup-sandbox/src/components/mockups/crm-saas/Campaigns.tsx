...
export function Campaigns() {
  ...
  return <div className="flex min-h-[100dvh] bg-[#f5f8fb] text-[#142238]"><Sidebar active="broadcast" /><main className="min-w-0 flex-1"><Topbar title="Campaigns" subtitle="Broadcasts, automation and audience reach" /><div className="relative p-5 md:p-7">
